          ...
          {caseStudies.map((study) => (
            ...
            >
              ...
              <div className="mt-4 sm:mt-5 grid gap-2.5 sm:gap-3.5">
                <div className="rounded-[18px] sm:rounded-[22px] border border-outline-variant/12 bg-black/10 p-3.5 sm:p-4">
                  <p className="text-[9px] sm:text-[10px] font-semibold uppercase tracking-[0.22em] text-outline">
                    Problema
                  </p>
                  <p className="mt-1.5 sm:mt-2 text-[0.85rem] sm:text-sm leading-[1.4] sm:leading-6.5 text-secondary md:text-[0.98rem]">
                    {study.problem}
                  </p>
                </div>
                ...
                <div className="rounded-[18px] sm:rounded-[22px] border border-primary/14 bg-primary/6 p-3.5 sm:p-4">
                  <p className="text-[9px] sm:text-[10px] font-semibold uppercase tracking-[0.22em] text-outline">
                    Valor comercial
                  </p>
                  <p className="mt-1.5 sm:mt-2 text-[0.85rem] sm:text-sm leading-[1.4] sm:leading-6.5 text-tertiary/88 md:text-[0.98rem]">
